...
// Group-definition validation belongs with the public group behavior even though the
// cases share the transaction fixture's imports and construction helpers.
